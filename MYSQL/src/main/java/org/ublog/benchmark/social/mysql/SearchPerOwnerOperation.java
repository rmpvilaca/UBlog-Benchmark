...
public class SearchPerOwnerOperation  extends SearchOperation{

	
	public SearchPerOwnerOperation(ComplexBenchMarkClient client,
			Set<String> tags) {
		super(client, tags);
	}
	...
	public String getName() {
		return "twitter:searchDirectMessages";
	}
