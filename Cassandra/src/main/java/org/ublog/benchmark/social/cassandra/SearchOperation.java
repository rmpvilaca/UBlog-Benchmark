...
public class SearchOperation implements BenchOperation, OperationListener {
	...
	public void handleFinishedOperation(DataStoreOperation op) {
		this.result = (Set<Map<String, String>>) ((GetByTagsOperation) op)
				.getResult();
	...
	public CollectionOperation getNextDBOperation() {
		start = true;
		CollectionOperation res = new GetByTagsOperation<Comparable>(client,
				SocialBenchmark.tweetsTable, this.tags);
